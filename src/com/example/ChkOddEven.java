...
public class ChkOddEven {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Enter a numberbetween 1 and 10");
        int num = in.nextInt();
        
        if(num>10){
        	System.out.println("Thats not between 1 and 10 dumbass");
        }
        
        if(num==67) {
        	System.out.println("1 In den beginne schiep God den hemel en de aarde.\r\n"
        			+ "\r\n"
